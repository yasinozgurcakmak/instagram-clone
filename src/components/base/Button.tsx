...
const Button = ({children, className, onClick, disable, submitting,  variant="primary", size="lg", type = "submit" } : ButtonType) => {
    ...
    return (
        <button type={type} onClick={onClick} disabled={disable} className={style}>
